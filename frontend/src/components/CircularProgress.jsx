...
const CircularProgress = ({ solved, total, easy, medium, hard, attempted, totalEasy, totalMedium, totalHard }) => {
    ...
    return (
        <div className="flex items-center justify-between p-8 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200 shadow-sm">
            {/* Circular Chart */}
            <div className="relative flex items-center justify-center">
                ...
                <div className="absolute text-center">
                    ...
                    <div className="text-xs text-gray-600 font-semibold mt-1">Solved</div>
                    {attempted > 0 && (
            ...
            <div className="flex flex-col gap-3 ml-8">
                <div className="bg-gradient-to-r from-green-50 to-green-100 px-6 py-3 rounded-lg border border-green-200">
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 px-6 py-3 rounded-lg border border-yellow-200">
                ...
                <div className="bg-gradient-to-r from-red-50 to-red-100 px-6 py-3 rounded-lg border border-red-200">
